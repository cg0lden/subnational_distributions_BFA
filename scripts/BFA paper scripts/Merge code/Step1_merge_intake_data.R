# Edited for Simone Passarelli's computer on 2/16/21
...
# Directories
inputdir <- "/Users/Simone/Dropbox/Github/subnational_distributions/all_intakes" # On Simone's computer
...
file_key <- tibble(filename=intake_files) %>% 
  ...
  mutate(nutrient=recode(nutrient,
                         ...
                         "vita"="Vitamin A",
                         "zinc"="Zinc")) %>%  #removed red and processed meats
  # Add nutrient units
