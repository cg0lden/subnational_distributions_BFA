...
# Testing the distributions with older data: NHANES 2013-2014
...
nhanes_day1 <- read_xpt(here("data", "raw", "United States", "older", "2013_2014" , "DR1TOT_H.XPT")) %>% 
...
nhanes_day2 <- read_xpt(here("data", "raw", "United States", "older", "2013_2014" , "DR2TOT_H.XPT")) %>% 
...
usa_merge <- read_xpt(here("data", "raw", "United States", "older", "2013_2014" , "DEMO_H.XPT")) %>% 
         clean_names() %>% 
...
# Change id type to be numeric
  ...
  save(usa_spade, file=here("data", "processed","Subnational distributions", "usa_2013_2014"), replace)   
