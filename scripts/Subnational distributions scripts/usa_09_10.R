...
# Testing the distributions with older data: NHANES 2009-2010
...
nhanes_day1 <- read_xpt(here("data", "raw", "United States", "older", "2009_2010" , "DR1TOT_F.XPT")) %>% 
...
nhanes_day2 <- read_xpt(here("data", "raw", "United States", "older", "2009_2010" , "DR2TOT_F.XPT")) %>% 
...
usa_merge <- read_xpt(here("data", "raw", "United States", "older", "2009_2010", "DEMO_F.XPT")) %>% 
  clean_names() %>% 
...
save(usa_spade, file=here("data", "processed","Subnational distributions", "usa_2009_2010"), replace)   
