...
# Testing the distributions with older data: NHANES 2007-2008
...
nhanes_day1 <- read_xpt(here("data", "raw", "United States", "older", "2007_2008" , "DR1TOT_E.XPT")) %>% 
...
nhanes_day2 <- read_xpt(here("data", "raw", "United States", "older", "2007_2008" , "DR2TOT_E.XPT")) %>% 
  ...
  select(!c("dr2tvd", "dr2tfa", "dr2tff", "dr2tfdfe","dr2_300",
...
usa_merge <- read_xpt(here("data", "raw", "United States", "older", "2007_2008" , "DEMO_E.XPT")) %>% 
  clean_names() %>% 
...
save(usa_spade, file=here("data", "processed","Subnational distributions", "usa_2007_2008"), replace)   
