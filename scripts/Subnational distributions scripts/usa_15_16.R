...
# Testing the distributions with older data: NHANES 2015-2016
...
nhanes_day1 <- read_xpt(here("data", "raw", "United States", "older", "2015_2016" , "DR1TOT_I.XPT")) %>% 
...
nhanes_day2 <- read_xpt(here("data", "raw", "United States", "older", "2015_2016" , "DR2TOT_I.XPT")) %>% 
...
usa_merge <- read_xpt(here("data", "raw", "United States", "older", "2015_2016" , "DEMO_I.XPT")) %>% 
  clean_names() %>% 
...
save(usa_spade, file=here("data", "processed","Subnational distributions", "usa_2015_2016"), replace)   
