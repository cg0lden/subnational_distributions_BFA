...
# Testing the distributions with older data: NHANES 2011-2012
...
nhanes_day1 <- read_xpt(here("data", "raw", "United States", "older", "2011_2012" , "DR1TOT_G.XPT")) %>% 
...
nhanes_day2 <- read_xpt(here("data", "raw", "United States", "older", "2011_2012" , "DR2TOT_G.XPT")) %>% 
...
usa_merge <- read_xpt(here("data", "raw", "United States", "older", "2011_2012", "DEMO_G.XPT")) %>% 
  clean_names() %>% 
...
save(usa_spade, file=here("data", "processed","Subnational distributions", "usa_2011_2012"), replace)   
